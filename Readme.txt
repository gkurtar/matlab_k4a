...
%   argSeqOfPcFilePaths -> a cell array which contains row vector of strings where each string denotes the depth data file path of
%						the corresponding indexed distances array i.e. { [da1.txt, da2.txt, da3.txt], [db1.txt, db2.txt, db3.txt] } 
